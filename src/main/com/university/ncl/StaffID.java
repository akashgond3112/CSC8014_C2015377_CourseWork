...
public final class StaffID {
    ...
    public static StaffID getInstance() {
        ...
        if (stfID != null) {
            // If we get the matching staff ID generate the staff ID again by making a recursive call to generate ID again and avoid duplicates, until we get a unique staffID
            getInstance();
        } else {
